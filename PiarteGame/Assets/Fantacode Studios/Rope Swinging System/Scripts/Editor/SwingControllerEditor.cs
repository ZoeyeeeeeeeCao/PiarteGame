...
namespace FS_SwingSystem
{
    ...
    public class SwingControllerEditor : Editor
    {
        ...
        SerializedProperty FS_CameraShakeBridgeAmount;
        SerializedProperty FS_CameraShakeBridgeDuration;
        ...
        private void OnEnable()
        {
            ...
            //camera
            FS_CameraShakeBridgeAmount = serializedObject.FindProperty("FS_CameraShakeBridgeAmount");
            FS_CameraShakeBridgeDuration = serializedObject.FindProperty("FS_CameraShakeBridgeDuration");
        ...
        {
            EditorGUILayout.PropertyField(FS_CameraShakeBridgeAmount, new GUIContent("Shake Amount", "The intensity of the camera shake when the hook is pulled."));
            EditorGUILayout.PropertyField(FS_CameraShakeBridgeDuration, new GUIContent("Shake Duration", "The duration of the camera shake when the hook is pulled."));
        }
